    ...
    public class Startup
    {
        ...
        private static void ConfigureAuthentication(IServiceCollection serviceCollection)
        {
            serviceCollection
                ...
                {
                    options.Authority = "https://securetoken.google.com/desarrollo-mobile---hunter";
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ValidateIssuer = true,
                        ValidIssuer = "https://securetoken.google.com/desarrollo-mobile---hunter",
                        ValidateAudience = true,
                        ValidAudience = "desarrollo-mobile---hunter",
        ...
        private static void ConfigureSwagger(IServiceCollection serviceCollection)
        {
            ...
            {
                c.SwaggerDoc("v1",
                    new OpenApiInfo { Title = "Hunter", Version = "v1" });
